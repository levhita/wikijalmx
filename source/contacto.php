...
render('main', $context, function($context){
	...
	<section class="container" id="contacto">
		...
		<div class="row">
			<div id="mc_embed_signup" class="col-lg-8">
					...
					<div id="mc_embed_signup_scroll">
						...
						<div class="mc-field-group size1of2">
							...
							<div class="datefield">
								...
								<span class="subfield monthfield"><input class="birthday " type="text" pattern="[0-9]*" value="" placeholder="MM" size="2" maxlength="2" name="BIRTHDAY[month]" id="mce-BIRTHDAY-month"> ( dd / mm )</span> 
						...
						<div class="clear right"><input type="submit" value="Suscribirme" name="subscribe" id="mc-embedded-subscribe" class="btn hot_pink"></div>
					</div>
				</form>
			...
			<div class="col-lg-4">
				<p><strong>Queremos escuchar te ti<br>
				¡Nos necesitamos!</strong></p>
				...
				<p>
					<a href="mailto:comunidad@wikijal.mx">comunidad@wikijal.mx</a><br>
					Tel: <a href="tel:(33) 16901383">(33) 16901383</a>
				</p>
